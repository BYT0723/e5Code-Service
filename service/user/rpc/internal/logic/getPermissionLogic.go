...
func (l *GetPermissionLogic) GetPermission(in *user.GetPermissionReq) (*user.GetPermissionRsp, error) {
	p := &model.Permission{}
	...
	return &user.GetPermissionRsp{Permission: int64(p.Permission)}, nil
}
